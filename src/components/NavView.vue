            ...
            <div>
                <div
                    ...
                    <nav class="hidden md:flex space-x-10">
                        <router-link to="/" class="text-base font-medium text-gray-200 hover:text-gray-900"> Home
                        </router-link>
                        <!-- <a href="#about" to="event" class="text-base font-medium text-gray-200 hover:text-gray-900"> About </a> -->
                        <router-link to="events" class="text-base font-medium text-gray-200 hover:text-gray-900"> Events
                        </router-link>
                        <a href="#contact" class="text-base font-medium text-gray-200 hover:text-gray-900"> Contact </a>

                    </nav>
                    <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                        <a href="#" class="whitespace-nowrap text-base font-medium text-gray-200 hover:text-gray-900"> Sign
                            in </a>
                        <a href="#"
